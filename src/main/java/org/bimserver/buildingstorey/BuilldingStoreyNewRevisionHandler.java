...
public class BuilldingStoreyNewRevisionHandler  implements NewRevisionHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(BuilldingStoreyNewRevisionHandler.class);
